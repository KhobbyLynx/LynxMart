        ...
        <div className="footer__content">
          <div className="footer__contact">
            <div className="contact__section">
              ...
              <div className="contact__info">
                <span className='span'>Address: 562 Wellington Street 32, San Francisco</span>
                <span className='span'>Phone: +01 2222 365 / (+91) 012345 6789</span>
          ...
          <div className="footer__links">
            <div className="footer__about">
              <h2>About</h2>
              {['About Us', 'Devlivery Information', 'Privacy Policy', 'Terms & Conditions', 'Contact Us'].map(link => (
                <Link className='link span' key={link}>{link}</Link>
              ))}
            </div>
